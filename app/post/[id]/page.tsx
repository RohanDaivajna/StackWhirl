        ...
        <div className="max-w-[1200px] mx-auto flex gap-x-10 mt-4 mb-10">
                        ...
                        {data.Comment.map((item)=>(
                            <div key={item.id} className="flex flex-col">
                                <div className="flex items-center gap-x-3">
                                    <img src={item.User?.imageUrl ? item.User.imageUrl : (typeof defaultimage === "string" ? defaultimage : defaultimage.src)} alt="avatar of user"
            ...
            <div className="w-[30%]">
                <Card className="p-0 m-0">
                    <div className="bg-muted p-4 font-semibold rounded-t-xl ">About Community</div>
                    <div className="p-4">
                        <div className="flex items-center gap-x-3">
                            <Image src={'https://avatar.vercel.sh/${data?.subName}'} 
